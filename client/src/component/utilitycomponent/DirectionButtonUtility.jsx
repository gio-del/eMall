export default function DirectionButtonUtility() {
  return (
    <div class="inline-flex items-center justify-center">
      <button className="w-full inline-flex justify-between items-center max-sm:px-2 px-4 h-11 rounded-full border-[1px] dark:border-tertiary border-dk-secondary font-light  dark:text-tertiary text-dk-secondary">
