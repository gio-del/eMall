...
\begin{figure}[H]
    \centering
    \subfloat[Home]{
        \includegraphics[scale=0.32,page=1]{src/mockups/home.pdf}
    }
    \subfloat[Selected EVCP]{
        \includegraphics[scale=0.32,page=1]{src/mockups/selectedStation.pdf}
    }
    \newline
...
\begin{figure}[H]
    \centering
    \subfloat[Car status]{
        \includegraphics[scale=0.32,page=1]{src/mockups/car.pdf}
    }
    \subfloat[Add a car]{
