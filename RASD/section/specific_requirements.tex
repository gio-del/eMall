...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{cX}
        ...
        \textbf{R20} & The system must allow authenticated user to book of an CP for a certain time interval                             \\
        \textbf{R21} & The system must allow booking of an CP if and only if it is free for the specified time interval                  \\
