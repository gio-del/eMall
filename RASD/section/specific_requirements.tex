...
\begin{figure}[H]
    \centering
    \subfloat[Home]{
        \includegraphics[scale=0.24]{src/mockups/home.png}
    }
    \subfloat[Selected EVCP]{
        \includegraphics[scale=0.24]{src/mockups/selectedStation.png}
    }
    \newline
    \subfloat[Book a charge]{
        \includegraphics[scale=0.24]{src/mockups/book_charge.png}
    }
    \subfloat[Cost details]{
        \includegraphics[scale=0.24]{src/mockups/book_cost.png}
    }
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat[Car and charge status]{
        \includegraphics[scale=0.24]{src/mockups/car.png}
    }
    \subfloat[Add car]{
        \includegraphics[scale=0.24]{src/mockups/car_add.png}
    }
    \newline
    \subfloat[Reservations]{
        \includegraphics[scale=0.24]{src/mockups/reservations.png}
    }
    \subfloat[Profile]{
        \includegraphics[scale=0.24]{src/mockups/profile.png}
    }
    \newline
    % following mockups
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[Dashboard]{
        \includegraphics[scale=0.20]{src/mockups/Dashboard.png}
    }
    \newline
    \subfloat[Charging Points]{
        \includegraphics[scale=0.20]{src/mockups/ChargingPointsDash.png}
    }
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[Dashboard]{
        \includegraphics[scale=0.20]{src/mockups/oneCPdash.png}
    }
    \newline
    \subfloat[Charging Points]{
        \includegraphics[scale=0.20]{src/mockups/reservationsDash.png}
    }
\end{figure}
