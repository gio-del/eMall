...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{cX}
        ...
        \textbf{G3} & Allows the owner of charging points to be reached by a large number of EV drivers looking for charging points\\
        \textbf{G4} & Provides smart managing of charging stations, including the register of reservations\\ \bottomrule
    \end{tabularx}
\end{table}
