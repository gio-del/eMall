...
The main actor in this system are the drivers and the CPOs - Charging Point Operators, who manage their columns, along with the DSOs - Distribution System Operator, in charge of distributing the energy.
\\
...
\begin{itemize}
    \item \textbf{Booking} allows EV's owners to book a charge. The remote booking avoids interference
    ...
    \item \textbf{Charging} allows EV's owners to charge an EV, remotely monitor their charging
    ...
    \item  \textbf{Managing an EVCP} allows CPOs to make statistics on live and historical details
