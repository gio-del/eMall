...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/QueryDBMS.pdf}
    \caption{Data Subsystem}
\end{figure}
Before implementing the Account Manager it is preferred to develop the Notification Manager.
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/NotificationQuery.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/AccountQuery.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/ConnectorAccountQuery.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/CP.pdf}
    \caption{Charging Points Subsystem}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/Reservation.pdf}
    \caption{Reservation Subsystem}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/Car.pdf}
    \caption{Car Subsystem}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{src/Integration/Suggestion.pdf}
